/*
* This program implements the classic Rock, Paper, Scissors game against the computer.
* It uses enums and structs to manage game state, choices, and results, demonstrating
...
void SetWinnerScreenColor(enWinner Winner)
{
    ...
    case enWinner::Computer:
    {
        ...
        cout << "\a"; // System beep for computer win
        break;
    }
    case enWinner::Player1:
    {
        system("color 2F"); // Green background for Player win
        break;
    }
    default:
...
void ShoFinalGameResults(stGameResults GameResults)
{
...
void StartGame()
{
    ...
    do
    {
        ...
        ShoGameOverScreen();
        ShoFinalGameResults(GameResults);
